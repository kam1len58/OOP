...
class Program
{
    static void Main(string[] args)
    {
        ...
        List<(int ProductCode, int Quanity)> batchOfProducts = new() { (1, 10), (2,9), (3, 8)};
        var result = shopManager.BuyBatchOfProducts(shop1, batchOfProducts);
        foreach( var product in result )
        {
            Console.WriteLine($"Стоимость партии товаров вышла на {product.TotalPriceBatch} рублей");
        }
    }
}
