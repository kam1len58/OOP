...
class Program
{
    static void Main(string[] args)
    {
        ...
        shop1.DeliveryOfGoods(new Product(5, "МЯСО"), 15, 551);
        shop1.DeliveryOfGoods(new Product(6, "РЫБА"), 20, 390);
        ...
        var shops=shopManager.SearchCheapestProduct(shop1, shop2, shop3, 5);
